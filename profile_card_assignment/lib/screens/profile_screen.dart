...
class _ProfileCardScreenState extends State<ProfileCardScreen> {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const Text('Flutter & Mobile App Developer', style: TextStyle(color: AppColors.primary, fontSize: 14.5, fontWeight: FontWeight.w600)),
  ...
  Widget _buildStatColumn(String count, String label, IconData icon, Color color) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Row(
  ...
  Widget _buildContactRow(IconData icon, String label, String value, Color color) {
    return Row(
      children: [
        ...
        Expanded(child: Text(value, overflow: TextOverflow.ellipsis, style: const TextStyle(color: AppColors.textPrimary, fontSize: 12.5, fontWeight: FontWeight.w500))),
      ],
    );
  }
