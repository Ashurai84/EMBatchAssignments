# 📱 Flutter Profile Card Assignment

<p align="center">
  <img src="profile_card_assignment/assets/profile_card_ui.png" width="380" alt="Flutter Profile Card UI Screenshot" style="border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);"/>
</p>
...
- **Assignment Folder:** [`profile_card_assignment/`](profile_card_assignment/)
...
```
EMBatchAssignments/ (branch: profile-card-assignment)
...
- 📄 **Word Submission Document:** [**`profile_card_assignment/Profile_Card_Assignment.docx`**](profile_card_assignment/Profile_Card_Assignment.docx)
- 📝 **Technical Learning Report:** [**`profile_card_assignment/WHAT_YOU_LEARNED.md`**](profile_card_assignment/WHAT_YOU_LEARNED.md)
